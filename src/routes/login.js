...
function Login() {
   /* The context */
    ...
    /* Use of state variables from context */
    ...
    function clearForm(){
        ...
        ctx.userIndex = null;
        /* Update & hide LogOut from navbar*/
        setLoggedIn(false);
    }

    /* Validate all fields--validate function inported from validate */
    const validateThis = () => {
        ...
        {show ? (
            ...
            body={
                <>
                    ...
                    placeholder="Enter email" value={email} onChange={e => {makeChange(e, setEmail)}}/><br/>
                    Password<br/>
                    <input type="password" className="form-control" id="password" 
                     placeholder="Enter password" value={password} 
                     onChange={e => {makeChange(e, setPassword)}}/><br/>
                    <button type="submit" disabled={!enable}className="btn btn-light" 
            ...
            body={
                <>
                    ...
                    <button type="submit" className="btn btn-light" 
                     onClick={clearForm}>Log Out</button>
                </>}
