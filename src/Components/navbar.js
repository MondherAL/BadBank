...
/* State variables*/
/* Required to show login/logout in the navbar */
/* based on whether the login has occurred or not */
...
function NavigationBar() {
    ...
    /* Using tate variable from context */ 
...
{/* Rendering the login option if loggedIn is false */}
...
{/* Rendering the logout option if loggedIn is true */}
                        {loggedIn && <LinkContainer to="login">
